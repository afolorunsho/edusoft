	...
	<div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li><a href="#"><i class="fa fa-user"></i>Enrolment</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
				...
				<div class="input-group">
					<div class="input-group-btn search-panel">
						...
						<ul class="dropdown-menu" role="menu"  id="rmenu">
						  ...
						  <li><a href="#" data-value="Tribe">Tribe</a></li>
				...
				$.get("{{ route('qryEnrolment') }}", {
						...
						if (data.length > 0) {
							$.each(data, function(i,l){
								...
								if(other_name == null || other_name == "") other_name = '';
								var row_data = '<tr>' +
									'<td align="right">'+ convertDate(l.reg_date) + '</td>'+
									'<td align="right">'+ convertDate(l.enrol_date) + '</td>'+
									'<td>' + l.reg_no +'</td>'+
									'<td>' + l.last_name +'</td>'+
									'<td>' + l.first_name +'</td>'+
									'<td>' + other_name +'</td>'+
