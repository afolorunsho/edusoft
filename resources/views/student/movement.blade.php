	...
	<div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-file-text-o"></i><a href="{{route('getPromotion')}}">Movement</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
    	<div class="col-lg-12">
            <ul class="nav nav-tabs">
                <li class="nav active"><a href="#input" data-toggle="tab" class="nav-tab-class">Input</a></li>
...
<script type="text/javascript">
	...
	function validateFormOnSubmit() {
		...
		try{
			...
			if( isafterDate($('#promotion_date').val()) == true) reason += "Movement Date cannot be after current date \n";
			
			if( $('#class_id_from').val() ==  $('#class_id_to').val()) reason += "No Movement: Same class selected \n";
	...
	$(document).on('click', '#promotion-search', function(e){
		...
		if(reason == ""){
			...
			table.clear();
			table.destroy();
			$.get("{{ route('searchPromotion') }}", {start_date: start_date, end_date: end_date}, function(data){
